...
/******/ 	__webpack_require__.p = "https://realworld-plutt-microapp-login.herokuapp.com/";
/******/
/******/
...
module.exports = window.fetch || (window.fetch = __webpack_require__(5)["default"] || __webpack_require__(5));
...
// EXTERNAL MODULE: ./node_modules/swr/node_modules/fast-deep-equal/index.js
var fast_deep_equal = __webpack_require__(6);
var fast_deep_equal_default = /*#__PURE__*/__webpack_require__.n(fast_deep_equal);

// CONCATENATED MODULE: ./node_modules/swr/esm/libs/is-document-visible.js
...
// CONCATENATED MODULE: ./node_modules/swr/esm/libs/is-online.js
function isOnline() {
...
var cache = new cache_Cache(); // state managers
...
var defaultConfig = {
  ...
  suspense: false,
  compare: fast_deep_equal_default.a
}; // Focus revalidate

var eventsBinded = false;

if (typeof window !== 'undefined' && window.addEventListener && !eventsBinded) {
  var config_revalidate = function revalidate() {
  ...
  window.addEventListener('visibilitychange', config_revalidate, false);
  window.addEventListener('focus', config_revalidate, false); // only bind the events once
...
// CONCATENATED MODULE: ./node_modules/swr/esm/libs/throttle.js
...
var use_swr_trigger = function trigger(_key) {
...
var use_swr_broadcastState = function broadcastState(key, data, error) {
  var updaters = CACHE_REVALIDATORS[key];
...
var mutate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee(_key, _data) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            return _context.abrupt("return", use_swr_trigger(_key, shouldRevalidate));
...
function useSWR() {
  ...
  var revalidate = Object(react["useCallback"])( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
    var revalidateOpts,
        loading,
        shouldDeduping,
        newData,
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 29:
            ...
            if (!shouldDeduping) {
              ...
              use_swr_broadcastState(key, newData, undefined);
            }
          ...
          case 38:
            ...
            if (stateRef.current.error !== _context2.t0) {
              ...
              if (!shouldDeduping) {
                ...
                use_swr_broadcastState(key, undefined, _context2.t0);
              }
            } // events and retry
...
// CONCATENATED MODULE: ./node_modules/swr/esm/use-swr-pages.js
...
function useSWRPages(pageKey, pageFn, SWRToOffset) {
  ...
  var _useState = Object(react["useState"])(cache.get(pageCountKey) || 1),
      _useState2 = _slicedToArray(_useState, 2),
      pageCount = _useState2[0],
      setPageCount = _useState2[1];

  var _useState3 = Object(react["useState"])(cache.get(pageOffsetKey) || [null]),
  ...
  var pageFnRef = Object(react["useRef"])(pageFn);
  var emptyPageRef = Object(react["useRef"])(false); // Page component (wraps `pageFn`)
  // for performance reason we need to memorize it

  var Page = Object(react["useCallback"])(function (props) {
  ...
  var loadMore = Object(react["useCallback"])(function () {
  ...
  var _pageFn = Object(react["useCallback"])(pageFn, deps);
  ...
  var pages = Object(react["useMemo"])(function () {
    ...
    for (var i = 0; i < pageCount; ++i) {
      if (!pageCache[i] || pageCache[i].offset !== pageOffsets[i] || pageCache[i].pageFn !== _pageFn) {
        ...
        pageCache[i] = {
          component: react_default.a.createElement(Page, {
...
// CONCATENATED MODULE: ./src/ListErrors.js
var ListErrors_ListErrors=function ListErrors(_ref){var errors=_ref.errors;return/*#__PURE__*/react_default.a.createElement("ul",{className:"error-messages"},Object.keys(errors).map(function(key){return/*#__PURE__*/react_default.a.createElement("li",{key:key},key," ",errors[key]);}));};/* harmony default export */ var src_ListErrors = (ListErrors_ListErrors);
...
var SERVER_BASE_URL="https://conduit.productionready.io/api";var APP_NAME="conduit";var ARTICLE_QUERY_MAP={"tab=feed":"".concat(SERVER_BASE_URL,"/articles/feed"),"tab=tag":"".concat(SERVER_BASE_URL,"/articles/tag")};var DEFAULT_PROFILE_IMAGE="https://static.productionready.io/images/smiley-cyrus.jpg";var DEFAULT_LIMIT=20;var DEFAULT_IMAGE_SOURCE="data:image/png;base64,";
// CONCATENATED MODULE: ./src/api.js
var Auth={current:function(){var _current=_asyncToGenerator(/*#__PURE__*/regenerator_default.a.mark(function _callee(){var user,token,response,data;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:user=window.localStorage.getItem("user");token=user&&user.token;_context.next=4;return browser_default()("/user",{method:"GET",headers:{Authorization:"Token ".concat(encodeURIComponent(token))}});case 4:response=_context.sent;_context.next=7;return response.json();case 7:data=_context.sent;return _context.abrupt("return",{ok:response.ok,data:data});case 9:case"end":return _context.stop();}}},_callee);}));function current(){return _current.apply(this,arguments);}return current;}(),login:function(){var _login=_asyncToGenerator(/*#__PURE__*/regenerator_default.a.mark(function _callee2(email,password){var response,data;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return browser_default()("".concat(SERVER_BASE_URL,"/users/login"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({user:{email:email,password:password}})});case 2:response=_context2.sent;_context2.next=5;return response.json();case 5:data=_context2.sent;return _context2.abrupt("return",{ok:response.ok,data:data});case 7:case"end":return _context2.stop();}}},_callee2);}));function login(_x,_x2){return _login.apply(this,arguments);}return login;}(),register:function(){var _register=_asyncToGenerator(/*#__PURE__*/regenerator_default.a.mark(function _callee3(username,email,password){var response,data;return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.next=2;return browser_default()("".concat(SERVER_BASE_URL,"/users"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({user:{username:username,email:email,password:password}})});case 2:response=_context3.sent;_context3.next=5;return response.json();case 5:data=_context3.sent;return _context3.abrupt("return",{ok:response.ok,data:data});case 7:case"end":return _context3.stop();}}},_callee3);}));function register(_x3,_x4,_x5){return _register.apply(this,arguments);}return register;}(),save:function(){var _save=_asyncToGenerator(/*#__PURE__*/regenerator_default.a.mark(function _callee4(user){var response,data;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_context4.next=2;return browser_default()("".concat(SERVER_BASE_URL,"/user"),{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({user:user})});case 2:response=_context4.sent;_context4.next=5;return response.json();case 5:data=_context4.sent;return _context4.abrupt("return",{ok:response.ok,data:data});case 7:case"end":return _context4.stop();}}},_callee4);}));function save(_x6){return _save.apply(this,arguments);}return save;}()};/* harmony default export */ var api = ({Auth:Auth});
// CONCATENATED MODULE: ./src/LoginForm.js
var LoginForm_LoginForm=function LoginForm(){var _React$useState=react_default.a.useState(false),_React$useState2=_slicedToArray(_React$useState,2),isLoading=_React$useState2[0],setLoading=_React$useState2[1];var _React$useState3=react_default.a.useState([]),_React$useState4=_slicedToArray(_React$useState3,2),errors=_React$useState4[0],setErrors=_React$useState4[1];var _React$useState5=react_default.a.useState(""),_React$useState6=_slicedToArray(_React$useState5,2),email=_React$useState6[0],setEmail=_React$useState6[1];var _React$useState7=react_default.a.useState(""),_React$useState8=_slicedToArray(_React$useState7,2),password=_React$useState8[0],setPassword=_React$useState8[1];var handleEmailChange=function handleEmailChange(e){return setEmail(e.target.value);};var handlePasswordChange=function handlePasswordChange(e){return setPassword(e.target.value);};var handleSubmit=/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/regenerator_default.a.mark(function _callee(e){var _yield$api$Auth$login,ok,data;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:e.preventDefault();setLoading(true);_context.next=4;return api.Auth.login(email,password);case 4:_yield$api$Auth$login=_context.sent;ok=_yield$api$Auth$login.ok;data=_yield$api$Auth$login.data;setLoading(false);setErrors(!ok?data.errors:[]);if(data&&data.user){window.localStorage.setItem("user",JSON.stringify(data.user));mutate("user",data.user);}if(ok){window.location.href="/";}case 11:case"end":return _context.stop();}}},_callee);}));return function handleSubmit(_x){return _ref.apply(this,arguments);};}();return/*#__PURE__*/react_default.a.createElement(react_default.a.Fragment,null,/*#__PURE__*/react_default.a.createElement(src_ListErrors,{errors:errors}),/*#__PURE__*/react_default.a.createElement("form",{onSubmit:handleSubmit},/*#__PURE__*/react_default.a.createElement("fieldset",null,/*#__PURE__*/react_default.a.createElement("fieldset",{className:"form-group"},/*#__PURE__*/react_default.a.createElement("input",{className:"form-control form-control-lg",type:"email",placeholder:"Email",value:email,onChange:handleEmailChange})),/*#__PURE__*/react_default.a.createElement("fieldset",{className:"form-group"},/*#__PURE__*/react_default.a.createElement("input",{className:"form-control form-control-lg",type:"password",placeholder:"Password",value:password,onChange:handlePasswordChange})),/*#__PURE__*/react_default.a.createElement("button",{className:"btn btn-lg btn-primary pull-xs-right",type:"submit",disabled:isLoading},"Sign in"))));};/* harmony default export */ var src_LoginForm = (LoginForm_LoginForm);
// CONCATENATED MODULE: ./src/index.js
var src_Login=function Login(_ref){var routeTo=_ref.routeTo;var internalRoute=function internalRoute(route){return function(e){event.preventDefault();routeTo(route);};};return/*#__PURE__*/react_default.a.createElement("div",{className:"auth-page"},/*#__PURE__*/react_default.a.createElement("div",{className:"container page"},/*#__PURE__*/react_default.a.createElement("div",{className:"row"},/*#__PURE__*/react_default.a.createElement("div",{className:"col-md-6 offset-md-3 col-xs-12"},/*#__PURE__*/react_default.a.createElement("h1",{className:"text-xs-center"},"Sign in"),/*#__PURE__*/react_default.a.createElement("p",{className:"text-xs-center"},/*#__PURE__*/react_default.a.createElement("a",{href:"/user/register",onClick:internalRoute("user/register")},"Need an account?")),/*#__PURE__*/react_default.a.createElement(src_LoginForm,null)))));};/* harmony default export */ var src = (src_Login);
// CONCATENATED MODULE: ./.plutt/child.jsx
/* harmony default export */ var child = __webpack_exports__["default"] = ({mount:function mount(mountElement,props){return react_dom_default.a.render(/*#__PURE__*/react_default.a.createElement(src,props),mountElement);},unmount:function unmount(mountElement){return react_dom_default.a.unmountComponentAtNode(mountElement);},update:function update(mountElement,props){return react_dom_default.a.render(/*#__PURE__*/react_default.a.createElement(src,props),mountElement);}});
